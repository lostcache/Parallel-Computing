...
<a href="https://www.sciencedirect.com/topics/computer-science/shared-memory-architecture" target="_blank" rel="noopener noreferrer">
  <img src={sharedMemoryArch.src} alt="Basic shared memory architecture, showing both Uniform memory access (UMA) and Non-uniform memory access (NUMA) models." width="500" />
</a>
...
<a href="https://www.researchgate.net/publication/272377248_Overview_of_Trends_Leading_to_Parallel_Computing_and_Parallel_Programming" target="_blank" rel="noopener noreferrer">
  <img src={distributedMemArch.src} alt="A diagram of a distributed memory system, showing multiple nodes with their own CPU and Memory, connected by a network." width="500" />
</a>
...
<a href="https://www.researchgate.net/publication/312593963_ADAPTIVE_PARALLEL_ELM_WITH_CONVOLUTIONAL_FEATURES_FOR_BIG_STREAM_DATA" target="_blank" rel="noopener noreferrer">
  <img src={hybridMemArch.src} alt="Hybrid distributed-shared memory architecture showing multiple nodes connected via network, with each node containing multiple CPUs and shared memory." width="500" />
</a>
