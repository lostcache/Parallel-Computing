...
This data movement is also extremely costly in terms of energy. **The energy required to move a piece of data from DRAM to the CPU can be orders of magnitude greater than the energy required to perform a floating-point operation on that data** [^9]. As a result, the von Neumann architecture is fundamentally inefficient for these tasks, leading to substantial energy consumption and acting as a major impediment to progress in AI computing [^9].
...
<div class="centered-image">
  <a href="https://people.freebsd.org/~lstewart/articles/cpumemory.pdf" target="_blank" rel="noopener noreferrer">
    <img src={harwardArch.src} alt="A diagram of the Modified Harvard Architecture, showing separate pathways for instructions and data to the CPU core, with separate L1i and L1d caches." width="500" />
  </a>
</div>

*Image Credit: Based on a diagram from ["What Every Programmer Should Know About Memory"](https://people.freebsd.org/~lstewart/articles/cpumemory.pdf) by Ulrich Drepper.*
...
[^13]: Hitting the Memory Wall: Implications of the Obvious - LibraOpen, accessed October 1, 2025, [https://libraopen.lib.virginia.edu/downloads/4b29b598d](https://libraopen.lib.virginia.edu/downloads/4b29b598d)
